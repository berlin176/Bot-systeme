...
const youtube = new YouTube("AIzaSyBgF_DE2_LljWPcgpftC9QlEw-SOoBX8qg"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyBgF_DE2_LljWPcgpftC9QlEw-SOoBX8qg"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@788858779495170089>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
...
client.on("message", message => {
  if (message.content === "hi") {
    message.channel.send("**:heart:mrhba bik:heart:**");
    message.channel.sendFile("");
  }
});
...
client.on("message", message => {
  if (message.content === "salam") {
    message.channel.send("**:wa3alikom salam:**");
    message.channel.sendFile("");
  }
});
